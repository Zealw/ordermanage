            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="产品编号" value="${product.productNum}" name="productNum">
                    </div>
                    <div class="col-md-2 title">路线名称</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="路线名称" value="${product.productName}" name="productName">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="产品价格" value="${product.productPrice}" name="productPrice">
                    </div>
                    ...
                    <div class="col-md-2 title rowHeight2x">产品信息</div>
                    <div class="col-md-10 data rowHeight2x">
                        <textarea class="form-control" rows="3" placeholder="${product.productDesc}" name="productDesc"></textarea>
                    </div>
